...
xcopy /y %~d0magic_window_setting_config.xml E:\Projects\完美横屏应用计划\3.红米专用\common\system\users\0\magic_window_setting_config.xml
xcopy /y %~d0magic_window_setting_config.xml E:\Projects\完美横屏应用计划\3.6Max专用\common\system\users\0\magic_window_setting_config.xml
...
xcopy /y %~d0nodrag\magicWindowFeature_magic_window_application_list.xml  E:\Projects\完美横屏应用计划\3.红米专用\common\system\magicWindowFeature_magic_window_application_list.xml
xcopy /y %~d0nodrag\magicWindowFeature_magic_window_application_list.xml  E:\Projects\完美横屏应用计划\3.6Max专用\common\system\magicWindowFeature_magic_window_application_list.xml
...
xcopy /y %~d0embedded_rules_list_redmi.xml E:\Projects\完美横屏应用计划\3.红米专用\common\product\etc\embedded_rules_list.xml
xcopy /y %~d0embedded_rules_list_6max.xml E:\Projects\完美横屏应用计划\3.6Max专用\common\product\etc\embedded_rules_list.xml
